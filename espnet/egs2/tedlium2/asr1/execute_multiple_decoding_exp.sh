...
./execute_decoding.sh --inference_nj 3 --inference_tag mel_modgd_gamma_cqtDefMel --path_to_conf e_conf/mel_modgd_gamma_cqt.yaml --test_sets test
...
#./execute_decoding.sh --inference_nj 2 --inference_tag mel_modgd_gamma_cqtDefMel --path_to_conf e_conf/mel_modgd_gamma_cqt.yaml
#./execute_decoding.sh --inference_nj 3 --inference_tag mel_modgd_gammaDefMel --path_to_conf e_conf/mel_modgd_gamma.yaml
