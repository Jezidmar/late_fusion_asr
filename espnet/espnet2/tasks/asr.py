...
from espnet2.asr.decoder.transformer_decoder import (
    ...
    TransformerDecoder,
    TransformerDecoder_MOE_SPARSE_MH,
    TransformerDecoder_MOE_SPARSE,
    TransformerDecoder_Combined_MOE,
)
...
from espnet2.asr.encoder.e_branchformer_encoder import (
    ...
    MidLevelFusion_v2,
    MidLevelFusion_v3,
    EBranchformerEncoder_PerceptualFusion,
    EBranchformerEncoder_PerceptualFusionWithoutSharing,
...
from espnet2.asr.frontend.default import DefaultFrontend, FeatFusedFrontend
...
from espnet2.asr.specaug.specaug import SpecAug, FusedFeatureSpecAug,FusedSpecAugDef
from espnet2.asr_transducer.joint_network import JointNetwork
from espnet2.layers.abs_normalize import AbsNormalize
from espnet2.layers.global_mvn import GlobalMVN,FusedFeatureNormalizeGlobal
from espnet2.layers.utterance_mvn import UtteranceMVN, FusedFeatureNormalize
...
specaug_choices = ClassChoices(
    ...
    classes=dict(
        specaug=SpecAug,
        specaug_fused=FusedFeatureSpecAug,
        specaug_fused_def=FusedSpecAugDef,
    ),
...
normalize_choices = ClassChoices(
    ...
    classes=dict(
        ...
        fused_utt_mvn=FusedFeatureNormalize,
        fused_global_mvn=FusedFeatureNormalizeGlobal,
    ),
...
encoder_choices = ClassChoices(
    ...
    classes=dict(
        ...
        transformer_moe=TransformerEncoderMOE,
        ...
        mid_level_fusion_v1=MidLevelFusion_v1,
        mid_level_fusion_v2=MidLevelFusion_v2,
        mid_level_fusion_v3=MidLevelFusion_v3,
        early_fusion_perceptual_sharing=EBranchformerEncoder_PerceptualFusion,
        early_fusion_perceptual_non_sharing=EBranchformerEncoder_PerceptualFusionWithoutSharing,
    ),
...
decoder_choices = ClassChoices(
    ...
    classes=dict(
        ...
        s4=S4Decoder,
        transformer_moe_sparse=TransformerDecoder_MOE_SPARSE,
        transformer_moe_sparse_mh=TransformerDecoder_MOE_SPARSE_MH,
        transformer_moe_combined=TransformerDecoder_Combined_MOE,
    ),
